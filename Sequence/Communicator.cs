...
namespace sssongVision.Sequence
{
    ...
    public delegate bool CallBack(object sender, IMessageDuplexCallback channel, MmiMessageInfo message, ClientInfo clinet);
    ...
    public class Communicator
    {
        ...
        {
            //#WCF_FSM#1 서버와 통신을 하기 위해서는, 약속된 클라이언트 이어야 함.
            ...
            Message content = new Message
            {
                ...
                MachineName = SettingXml.Instance.MachineName
            };
