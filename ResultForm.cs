...
{
    //ResultForm WinForm 클래스 생성 - 검사 결과를 표시하는 폼
    //검사 결과를 출력하기 위한 TreeListView 컨트롤을 사용하기 위해,
    // ExternalLib\Dll\ObjectListView\ObjectListView.dll을 참조에 추가할것
    // using BrightIdeasSoftware; 코드 추가
    // ResultForm에 TreeListView와 자세한 결과를 보여주는 TextBox, 2개 컨트롤을 상하로 분리하는 SplitContainer 추가
