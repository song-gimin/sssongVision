...
namespace sssongVision.Setting
{
    public partial class PathSetting : UserControl
    {
        ...
        {
            //환경설정에서 모델 저장 경로 얻기
            txtModelDir.Text = SettingXml.Instance.ModelDir;
            txtImageDir.Text = SettingXml.Instance.ImageDir;
        ...
        {
            //환경설정에 모델 저장 경로 설정
            SettingXml.Instance.ModelDir = txtModelDir.Text;
            SettingXml.Instance.ImageDir = txtImageDir.Text;
